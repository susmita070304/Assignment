    ...
    <div className="flex flex-col md:flex-row min-h-screen bg-zinc-950 text-zinc-50 font-sans overflow-x-hidden">
      ...
      >
        ...
        >
          ...
          <div
            id="profileCard"
            className="bg-zinc-950 p-6 sm:p-10 rounded-xl border border-zinc-800 w-full min-h-[20rem] md:min-h-[25rem] flex flex-col items-start justify-between text-left transition-colors duration-300 group-hover:border-zinc-700"
          >
